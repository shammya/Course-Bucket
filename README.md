...
![Badge](https://visitor-counter-badge.vercel.app/api/shammya/Course-Bucket?label=Visitors&color=EA6607&labelColor=451E0E) [![youtube views](https://img.shields.io/youtube/views/nm_V5exioyI?style=for-the-badge&logo=youtube&logoColor=white&label=youtube%20views&labelColor=ff0000&color=grey)](https://youtu.be/nm_V5exioyI)
...
![Homepage](database/images/fgifs/1hompage.gif)

#### Account Settings

![Homepage](database/images/fgifs/2ac_Set.gif)

#### Overview

![Homepage](database/images/fgifs/3overview.gif)

#### Purchase History

![Homepage](database/images/fgifs/4purchase_history.gif)

#### Review

![Homepage](database/images/fgifs/5review.gif)

#### FAQ

![Homepage](database/images/fgifs/6faq.gif)

#### Enrolled Students

![Homepage](database/images/fgifs/7enrolled_students.gif)

#### About Teacher

![Homepage](database/images/fgifs/8about_teacher.gif)

#### Create Course

![Homepage](database/images/fgifs/9create_course.gif)

#### Admin Panel

![Homepage](database/images/fgifs/10admin.gif)

#### Student

![Homepage](database/images/fgifs/11student.gif)

#### Search Filter

![Homepage](database/images/fgifs/12search_filter.gif)

#### Purchase Course

![Homepage](database/images/fgifs/13purchase.gif)
