...
//    }
	...
	public static void createNewReview(ReviewDb review) {
		...
		String teacherUsername = DB.getString("course", "id", review.getCourseId().toString(), "teacher_id");
		Notification.generateNotification(teacherUsername, review.getStudentId(), review.getCourseId(), "REVIEW", id);
	}
	...
	public static void createNewRating(RatingDb rating) {
		...
		String teacherUsername = DB.getString("course", "id", rating.getCourseId().toString(), "teacher_id");
		Notification.generateNotification(teacherUsername, rating.getStudentId(), rating.getCourseId(), "REVIEW", id);
