...
//	}
	...
	public static void generateNotification(String userId,String fromId,Integer courseId,String type,Integer eventId) {
		Integer id = DB.generateId("notification");
		String sql = "insert into notification values( #,'#','#',#,'F',#,'#',#)";
		DB.execute(sql,id.toString(),userId,fromId,ToolKit.JDateToDDate(new Date()),courseId.toString(),type,eventId.toString() );
